                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <Input
                                    ...
                                    className={cn("mt-2", errors.nama && "border-red-500 focus:border-red-500")}
                                />
                ...
                <Card className="mt-8 p-6">
                    <div className="text-right">
                        ...
                        <div className="mt-4 p-4 bg-gray-100 rounded text-left text-sm">
                            <p>
                                <strong>Nama:</strong> Harfi Novian
                            </p>
                            <p>
                                <strong>Tanggal Lahir:</strong> 01/11/1995
                            </p>
                            <p>
                                <strong>Jenis Kelamin:</strong> Laki - Laki
                            </p>
                            <p>
                                <strong>Pesan:</strong> Log Belajar Duit Website
                            </p>
                        </div>
                    </div>
                </Card>
