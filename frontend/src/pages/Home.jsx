...
const Home = () => {
    const headquarters = [
        ...
        {
            city: "bandung",
            img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Bandung_View_dari_Gedung_Wisma_HSBC_Asia_Afrika_4.jpg/1200px-Bandung_View_dari_Gedung_Wisma_HSBC_Asia_Afrika_4.jpg"
        },
        {
            city: "surabaya",
            img: "https://unair.ac.id/wp-content/uploads/2023/06/1677056343_1-1024x682.webp"
        }
    ];
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="bg-white py-20 px-6">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="text-5xl font-bold text-gray-900 mb-4">Hi 👋, Welcome To My Website</h1>
                    <p className="text-xl text-gray-600 mb-8">My name is Muhammad Rizki Ramadhan</p>
                </div>
            </section>
            ...
            <section className="bg-gray-50 py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">Your Trusted Travel Agent's</h2>
                        <p className="text-xl text-gray-600">Your happiness is our happiness</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-gray-800 text-white py-3 px-6 rounded-md font-semibold hover:bg-gray-900 transition-colors duration-200"
                                >
                                    SEND
                                </button>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                title: "Japan",
                                description:
                                    "Travel dan wisata di Japan, kunjungi cagar budaya dan kuliner yang menarik"
                            },
                            {
                                icon: <MapPin className="w-8 h-8 text-blue-500" />,
                                title: "Singapore",
            ...
            <section className="bg-white py-16 px-6 text-center">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-4xl font-bold text-gray-900 mb-6">Your Closing Argument Headline</h2>
                    <p className="text-lg text-gray-600 mb-8">
                        Suspendisse egestas rhoncus urna in bibendum. Donec urna neque, euismod sed justo quis,
                        convallis dapibus risus. Phasellus fringilla odio vel erat fringilla.
                    </p>
