            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Showcasing my work in web development and travel industry expertise. Each project represents a
                ...
                <section className="mb-16">
                    <img src="../pictures/project1.png" alt="" />
                        ...
                        <div className="space-y-8">
                            <div className="border-l-4 border-blue-500 pl-6">
                                ...
                                <p className="text-gray-600">
                                    ...
                                    Specialized in creating user-friendly booking systems and destination showcase
                                    websites.
                                </p>
                            </div>
                            ...
                            <div className="border-l-4 border-green-500 pl-6">
                                ...
                                <p className="text-gray-600">
                                    Developed and maintained various web applications for local businesses. Gained
                                    expertise in modern frameworks and database design.
                                </p>
                            </div>
                            ...
                            <div className="border-l-4 border-purple-500 pl-6">
                                ...
                                <p className="text-gray-600">
                                    Started my professional journey learning web development fundamentals and working on
